...
kenya_province <- st_read("shape_files/KEN_adm1.shp")
...
kenya_counties <- st_read("shape_files/ken_admbnda_adm1_iebc_20191031.shp") 
...
gps_clusters <- st_read("Kenya_Clusters/KEGE8AFL.shp")
...
kenya_subcounties <-  st_read("shape_files/ke_subcounty.shp")
...
shapefile_path <- "shape_files/Kenya_2019_Population_Data_KNBS.shp"
